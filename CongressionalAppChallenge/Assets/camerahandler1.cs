...
public class camerahandler1 : MonoBehaviour
{
    ...
    //lets you move left and right further
    ...
    void ZoomCamera(float offset, float speed)
    {
        ...
        cam.GetComponent<Camera>().orthographicSize = Mathf.Clamp(cam.GetComponent<Camera>().orthographicSize - (offset * speed), ZoomBounds[0], ZoomBounds[1]);
